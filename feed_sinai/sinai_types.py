...
class ConceptualWork(BaseModel):
    ...
    creator: tuple[AssocNameItemUnmerged, ...] | tuple[AssocNameItemMerged, ...] = tuple()
...
class ParaItem(BaseModel):
    ...
    as_written: Optional[NonEmptyStr] = None
    translation: tuple[str, ...] = tuple()
    assoc_name: tuple[AssocNameItemUnmerged, ...] | tuple[AssocNameItemMerged, ...] = tuple()
    assoc_place: tuple[AssocPlaceItemUnmerged, ...] | tuple[AssocPlaceItemMerged, ...] = tuple()
...
class InscribedLayer(BaseModel):
    ...
    text_unit: tuple[LayerTextUnitUnmerged, ...] | tuple[LayerTextUnitMerged, ...] = Field(
        ..., min_length=1
    )
    para: tuple[ParaItemUnmerged, ...] | tuple[ParaItemMerged, ...] = tuple()
    assoc_date: tuple[AssocDateItem, ...] = tuple()
...
class ManuscriptObject(BaseModel):
    ...
    assoc_date: tuple[AssocDateItem, ...] = tuple()
    assoc_name: tuple[AssocNameItemMerged, ...] | tuple[AssocNameItemUnmerged, ...] = tuple()
    assoc_place: tuple[AssocPlaceItemUnmerged, ...] | tuple[AssocPlaceItemMerged, ...] = tuple()
    note: tuple[NoteItem, ...] = tuple()
    related_mss: tuple[RelatedMs, ...] = tuple()
...
class ManuscriptObjectMerged(ManuscriptObject):
    ...
    layer: tuple[ManuscriptLayerUnmerged, ...] = Field(tuple(), max_length=0, exclude=True)
