...
class LabelWithIdentifier(BaseModel):
    id: NonEmptyStr
    label: NonEmptyStr
...
class Agent(BaseModel):
    ...
    gender: Optional[LabelWithIdentifier] = None
...
class ConceptualWork(BaseModel):
    ...
    orig_lang: Optional[LabelWithIdentifier] = None
    orig_lang_title: Optional[NonEmptyStr] = None
    alt_title: Optional[List[NonEmptyStr]] = None
    desc: Optional[NonEmptyStr] = None
    genre: Optional[List[LabelWithIdentifier]] = None
    creator: Optional[List[AssocNameItem]] = None
...
class WorkBrief(BaseModel):
    ...
    genre: Optional[List[LabelWithIdentifier]] = Field(None, min_length=1)
...
class WorkWitItem(BaseModel):
    work: WorkBrief | WorkStub | ConceptualWork
...
class ParaItem(BaseModel):
    type: LabelWithIdentifier
    locus: NonEmptyStr
    lang: List[LabelWithIdentifier] = Field(..., min_length=1)
...
class TextUnit(BaseModel):
    ...
    features: Optional[List[LabelWithIdentifier]] = None
...
class InscribedLayer(BaseModel):
    ark: Ark
    reconstruction: bool
    state: LabelWithIdentifier = Field(
...
class Part(BaseModel):
    ...
    summary: Optional[NonEmptyStr] = None
    locus: Optional[NonEmptyStr] = None
    support: List[LabelWithIdentifier] = Field(..., min_length=1)
    extent: Optional[NonEmptyStr] = Field(
        None,
        description="The extent, expressed in number of folios, which comprise the manuscript object",
    )
